...
class  TicketList extends Component {
  ...
  getBuserName(value){
    ...
    let url = 'api/prebatch/?rowCount=10&pageIndex=1&userName='+userName+'&wxtoken='+wxtoken;
  ...
  renderLists() {
    ...
    return value.map(datas =>{
        return <li className="cabListLi" key={datas.prebatch}>
            <dl>
                ...
                <dd className="cabListLi-msg weui-flex">
                    <p className="msg-p-all weui-flex__item">{datas.Instructions}</p>
                </dd>
                {
                   datas.showname == 0? 
                    <dd className="cabListLi-msg  weui-flex ">
                   ...
                   <dd className="cabListLi-msg  weui-flex ">
                        <p className=" weui-flex__item">{datas.Phone}</p>
                        <p className=" weui-flex__item">{datas.compName}</p>
                    </dd>
                }
                <dd className="cabListLi-msg  weui-flex">
  ...
  render() {
    ...
    return (
        <div className="cabMain">
            <BackT tit='平台卡卷展示' backonClick={this.props.backMain} ></BackT>
